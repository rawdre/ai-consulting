(() => {
  ...
  function update(){
    ...
    $('menu-guide').innerHTML=`<strong>${esc(state.style)} · ${tier.tier} menu</strong><br>${tier.includedMains} main${tier.includedMains===1?'':'s'}, ${tier.includedSides} sides & 1 salad included. Your package adjusts with your mains.<br>Beyond the largest package: extra mains +$6.50/guest. Extra sides or salads +$3.50/guest. Premium dishes and appetizers add the prices shown.`;
